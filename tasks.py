...
from src.application.news_scrapper import NewsScrapper
from src.infrastructure.browsers.chrome_browser import ChromeBrowser
from src.infrastructure.repositories.ap_news_repository import APNewsRepository
